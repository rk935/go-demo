...
import (
	...
	"github.com/zzn99/demo/ent"
	"github.com/zzn99/demo/ent/car"
	"github.com/zzn99/demo/ent/group"
	"github.com/zzn99/demo/ent/user"

	_ "github.com/go-sql-driver/mysql"
)

func main() {
	client, err := ent.Open("mysql", "root:root@tcp(192.168.56.101:3306)/test?parseTime=True", ent.Debug())
	if err != nil {
